...
// Default model for chat - using a capable free/low-cost model
...
2. If there are no documents attached yet (no context provided), respond with exactly: "add documents first".
